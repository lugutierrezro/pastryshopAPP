                          ...
                          if (item.opcionesPersonalizadas != null) ...[
                            if (item.opcionesPersonalizadas!['adicionales'] != null)
                              Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: List.from(item.opcionesPersonalizadas!['adicionales']).map((ad) => 
                                    Text('+ ${ad['nombre']}', style: const TextStyle(color: Colors.blueGrey, fontSize: 12))
                                  ).toList(),
                                ),
                              ),
                            if (item.opcionesPersonalizadas!['notas'] != null)
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.sticky_note_2, size: 14, color: Colors.orange),
